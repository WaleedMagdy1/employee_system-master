        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    ...
                    <form action="actions/addempprocess.php" method="POST" >
                        ...
                        <div style="color:red;"><?php if(in_array("email",$arr_error)){echo "Enter Valid Email!!<br>";} ?></div>
                        <div style="color:red;"><?php if(in_array("password",$arr_error)){echo "Enter Valid Password & Greater than 5 characters<br>";} ?></div>
                        <div style="color:red;"><?php if(in_array("phone",$arr_error)){echo "Enter Valid phone !!<br>";} ?></div>
                        <div style="color:red;"><?php if(in_array("emails",$arr_error)){echo "This Email Already Exist!!<br>";} ?></div>
                    </form>
                </div>
            </div>
        </div>
