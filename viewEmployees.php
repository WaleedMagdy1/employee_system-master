...
?>                   
            ...
            <?php
                ...
                echo "<td><img class='title rounded-circle' src=' $values' width='100px' height='100px'></td>" ;
              }
            }
            ?> 
                <td>
                        <a class="btn btn-danger" href="actions/deleteEmployee.php?id=<?= $row['id']; ?>">Delete</a>
                </td>
            </tr>
            <?php
            }}
